...
BitcoinGUI::BitcoinGUI(QWidget *parent):
    ...
    rpcConsole(0)
{
    setStyleSheet("font-weight:300;font-size:12px;font-family:'Century-Gothic'");
    QString ss("QMenuBar::item { background-color: transparent }");
    menuBar()->setStyleSheet(ss);
    resize(780, 550);
    setWindowTitle(tr("Architectcoin") + " - " + tr("Wallet"));

qApp->setStyle(QStyleFactory::create("Fusion"));
QPalette palette;
palette.setColor(QPalette::Window, QColor(246,235,209));
palette.setColor(QPalette::WindowText, Qt::black);
palette.setColor(QPalette::Base, QColor(241,220,187));
palette.setColor(QPalette::AlternateBase, QColor(241,212,169));
palette.setColor(QPalette::ToolTipBase, Qt::white);
palette.setColor(QPalette::ToolTipText, Qt::black);
palette.setColor(QPalette::Text, Qt::black);
palette.setColor(QPalette::Button, QColor(244,165,76));
palette.setColor(QPalette::ButtonText, Qt::black);
palette.setColor(QPalette::BrightText, Qt::red);
 
palette.setColor(QPalette::Highlight, QColor(247,170,16).lighter());
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Architectcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Architectcoin"), this);
    aboutAction->setToolTip(tr("Show information about Architectcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Architectcoin"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("#toolbar { font-weight:300;border:none;height:100%;padding-top:20px; background: rgb(88,24,3); text-align: left; color: white;min-width:160px;max-width:160px;} QToolBar QToolButton:hover {background:rgb(247,170,16);} QToolBar QToolButton:checked {background:rgba(247,170,0,100);}  QToolBar QToolButton { font-weight:300;font-size:12px;font-family:'Centiry-Gothic';padding-left:20px;padding-right:161px;padding-top:5px;padding-bottom:5px; width:100%; color: white; text-align: left; background:transparent;text-transform:uppercase; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Architectcoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Architectcoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Architectcoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Architectcoin address or malformed URI parameters."));
    }
